...
public class MathCalculator {
    ...
    public static double sumOfSumSubMultDiv(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчёта равен: " + sumOfSubtractionAndDivision(10, 20));
        System.out.println("Результат расчёта равен: " + sumOfSumSubMultDiv(10, 20));
    }
}
